...
public abstract class Layer { 
    ...
    protected void  createWindow(Graphics g){
    			...
    			//中上
    			g.drawImage(Img.WINDOW, x+BORDER, y, w+x-BORDER, y+BORDER, BORDER, 0, WINDOW_W-BORDER, BORDER, null);
    			//右上
    			...
    			//中下
    			g.drawImage(Img.WINDOW, x+BORDER, y+h-BORDER, w+x-BORDER, y+h, BORDER, WINDOW_H-BORDER, WINDOW_W-BORDER, WINDOW_H, null);
    			//右下
